...
import de.iip_ecosphere.platform.connectors.types.AbstractInputConnectorTypeTranslator;
import de.iip_ecosphere.platform.connectors.types.AbstractOutputConnectorTypeTranslator;
...
public class BaSyxAasConnectorTest {
    ...
    private static class OutputTranslator extends AbstractOutputConnectorTypeTranslator<Object, MachineData, Object> {
        ...
        public MachineData to(Object source) throws IOException {
            ModelAccess<Object> access = getModelAccess();
            // as the connector accepts Objects, also directly casting would be ok
            return new MachineData(
                access.toInt(access.get(QNAME_VAR_LOTSIZE)), 
                access.toDouble(access.get(QNAME_VAR_POWCONSUMPTION)));
        }
    ...
    @Generated("Specified in IVML, generated by EASy")
    private static class InputTranslator extends AbstractInputConnectorTypeTranslator<MachineCommand, Object, Object> {
        ...
        public Object from(MachineCommand data) throws IOException {
            ...
            if (data.lotSize > 0) {
                ...
                getModelAccess().set(QNAME_VAR_LOTSIZE, getModelAccess().fromInt(data.lotSize));
            }
