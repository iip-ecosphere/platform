...
public class AbstractOpcUaConnectorTest {
    ...
    private static class OutputTranslator extends AbstractOutputConnectorTypeTranslator<DataItem<Variant>, MachineData, 
        Variant> {
    ...
    @Generated("Specified in IVML, generated by EASy")
    private static class InputTranslator extends AbstractInputConnectorTypeTranslator<MachineCommand, Object, Variant> {
