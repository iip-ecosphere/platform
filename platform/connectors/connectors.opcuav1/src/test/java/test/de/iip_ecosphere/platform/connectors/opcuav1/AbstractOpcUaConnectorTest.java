    ...
    private static class OutputTranslator extends AbstractConnectorOutputTypeTranslator<DataItem, MachineData> {
        ...
        public MachineData to(DataItem source) throws IOException {
            ...
            return new MachineData(
                (int) access.get(Namespace.QNAME_VAR_LOT_SIZE), 
                (double) access.get(Namespace.QNAME_VAR_POWER_CONSUMPTION),
                vendor.getVendor());
        }
    ...
    private static class InputTranslator extends AbstractConnectorInputTypeTranslator<MachineCommand, Object> {
        ...
        public Object from(MachineCommand data) throws IOException {
            ...
            if (data.getLotSize() > 0) {
                getModelAccess().set(Namespace.QNAME_VAR_LOT_SIZE, (int) data.getLotSize());
                getModelAccess().setStruct(Namespace.QNAME_VAR_STRUCT, 
