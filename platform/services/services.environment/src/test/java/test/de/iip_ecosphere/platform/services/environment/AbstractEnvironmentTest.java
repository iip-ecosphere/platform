...
public abstract class AbstractEnvironmentTest {
     ...
     */
    public static void testAas(Endpoint registry) throws IOException, ExecutionException {
        ...
        assertProperty(submodel, AasCreator.AAS_SUBMODEL_PROPERTY_NAME, o -> checkNonEmptyString(o));
        assertProperty(submodel, AasCreator.AAS_SUBMODEL_PROPERTY_DESCRIPTION, o -> checkNonEmptyString(o));
        assertProperty(submodel, AasCreator.AAS_SUBMODEL_PROPERTY_VERSION, o -> checkNonEmptyString(o));
        ...
        assertOperation(submodel, AasCreator.AAS_SUBMODEL_OPERATION_SETSTATE, 
            o -> checkBoolean(o, true), ServiceState.RUNNING.name());
