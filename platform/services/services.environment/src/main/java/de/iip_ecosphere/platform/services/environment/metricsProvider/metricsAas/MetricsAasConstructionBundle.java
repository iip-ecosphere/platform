...
public class MetricsAasConstructionBundle {
    ...
    private Function<String, String> nameMapper = s -> s;
     ...
     */
    public MetricsAasConstructionBundle(SubmodelElementContainerBuilder smBuilder, ProtocolServerBuilder pBuilder,
    ...
    /**
     * Defines the metrics filter.
     * 
     * @param filter the filter, may be <b>null</b> for none
     */
    ...
    /**
     * Defines the implementation (protocol) name mapper.
     * 
     * @param nameMapper the implementation (protocol) name mapper
     */
    public void setNameMapper(Function<String, String> nameMapper) {
        this.nameMapper = nameMapper;
    }

    /**
     * Sets the submodel/elements builder.
     * 
     * @param smBuilder submodel builder
     * @throws IllegalArgumentException if the argument is null
     */
    public void setSubmodelBuilder(SubmodelElementContainerBuilder smBuilder) {
        if (smBuilder == null) {
    ...
    /**
     * Returns the metrics filter.
     * 
     * @return the metrics filter, may be <b>null</b>
     */
    ...
    /**
     * Returns the implementation (protocol) name mapper.
     * 
     * @return the implementation (protocol) name mapper
     */
