...
public class MetricsProvider {
    ...
    private static final String SYS_MEM_TOTAL = "system.memory.total";
    private static final String SYS_MEM_FREE = "system.memory.free";
    private static final String SYS_MEM_USED = "system.memory.used";
    private static final String SYS_MEM_USAGE = "system.memory.usage";

    private static final String SYS_DISK_TOTAL = "system.disk.total";
    private static final String SYS_DISK_FREE = "system.disk.free";
    private static final String SYS_DISK_USABLE = "system.disk.usable";
    private static final String SYS_DISK_USED = "system.disk.used";

    // Error Messages
    private static final String ID_NOT_FOUND_ERRMSG = ": no item found with this identifier!";
    private static final String NON_POSITIVE_ERRMSG = ": is not a positive number!";
    private static final String NULL_ARG = " has a null value. This argument cannot be null!";
     ...
     */
    private void registerNonNativeSystemMetrics() {
        memoryBaseUnit = CapacityBaseUnit.valueOf(memoryBaseUnitString.toUpperCase());
        diskBaseUnit = CapacityBaseUnit.valueOf(diskBaseUnitString.toUpperCase());
     ...
     * unit.
     */
    protected void registerMemoryMetrics() {
     ...
     * base unit.
     */
    protected void registerDiskMetrics() {
     ...
     */
    protected void removeMemoryMetrics() {
     ...
     */
    protected void removeDiskMetrics() {
     ...
     * @throws IllegalArgumentException if the identifier is null
     */
    private void addTimer(String timerId) {
        if (timerId == null) {
    ...
    private void calculateNonNativeSystemMetrics() {
        if (init) {
     ...
     */
    protected String getMeter(String name, Iterable<Tag> tags) {
        try {
     ...
     */
    protected String getGauge(String name) {
     ...
     */
    protected String getCounter(String name) {
     ...
     */
    protected String getTimer(String name) {
     ...
     */
    protected String getCustomGaugeList() {
     ...
     *         counters
     */
    protected String getCustomCounterList() {
     ...
     */
    protected String getCustomTimerList() {
