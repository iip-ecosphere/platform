...
public class MetricsProviderTest {
    ...
    public void setUpMetricsProvider() {
        provider = new MetricsProvider(new SimpleMeterRegistry());
    }
    ...
    public void testInitOk() {
        MetricsProvider mProvider = new MetricsProvider(new SimpleMeterRegistry());
    ...
    public void testInitNull() {
        assertThrows(IllegalArgumentException.class, () -> new MetricsProvider(null));
    }
    ...
    /*
     * Note, as there is no scheduling in the Unit Test environment, this values are
     * never initialized and are, from the start, null
     */
    ...
    public void setMemoryBaseUnitOk() {
        assertNull(provider.getMemoryBaseUnit());
    ...
    public void setDiskBaseUnitOk() {
        assertNull(provider.getDiskBaseUnit());
