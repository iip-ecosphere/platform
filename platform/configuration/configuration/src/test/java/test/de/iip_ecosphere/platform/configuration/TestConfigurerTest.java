...
public class TestConfigurerTest {
    ...
    public void testConfigurer() {
        TestConfigurer t = new TestConfigurer("ContainerCreation", new File("src/test/easy/single"), new File("."));
        ...
        t = new TestConfigurer("ContainerCreation", new File("src/test/easy/single"), new File("."))
            .setProperty("a", "b");
