project IDTA_02003_TechnicalData {
  ...
  AasSubmodelType TechnicalData = {
    ...
    description = "Submodel containing technical data of the asset and associated product classificatons.",
    versionIdentifier = "IDTA 02003-1-2",
    fixedName = true,
    fields = {
      AasField {
      ...
      AasField {
        ...
        minimumInstances = 1,
        maximumInstances = 1,
        description = "Technical and product properties. Individual characteristics that describe the product and its technical properties."
      },
      AasField {
  ...
  AasSubmodelElementCollectionType GeneralInformation = {
    ...
    fields = {
      ...
      AasField {
        ...
        minimumInstances = 0,
        maximumInstances = 1,
        examples = {"MimeType = image/png Value = /aasx/TechnicalData/logo.png"},
      ...
      AasField {
        ...
        minimumInstances = 1,
        maximumInstances = 1,
        examples = {"Electrical energy accelerator@en","Elektrischer Energie Beschleuniger@de"},
      ...
      AasField {
        ...
        type = refBy(AasFileResourceType),
        minimumInstances = 0,
        examples = {"MimeType = image/jpg Value = /aasx/TechnicalData/ ProdFromTop.jpg"},
  ...
  AasSubmodelElementCollectionType ProductClassifications = {
    name = "ProductClassifications",
    semanticId = "iri:https://admin-shell.io/ZVEI/TechnicalData/ProductClassifications/1/1",
    description = "Product classifications by association with product classes in common classification systems.",
    versionIdentifier = "IDTA 02003-1-2",
    fixedName = true,
    fields = {
      AasField {
  ...
  AasSubmodelElementCollectionType ProductClassificationItem = {
    name = "ProductClassificationItem",
    semanticId = "iri:https://admin-shell.io/ZVEI/TechnicalData/ProductClassificationItem/1/1",
    description = "Single product classification by association with product class in a particular classification system or property dictionary.",
    versionIdentifier = "IDTA 02003-1-2",
    fields = {
      AasField {
  ...
  AasSubmodelElementCollectionType FurtherInformation = {
    ...
    fields = {
      AasField {
        ...
        type = refBy(AasMultiLangStringType),
        minimumInstances = 0,
        examples = {"Restricted use Restricted use@en","Eingeschränkter Geltungsbereich@de"},
      ...
      AasField {
        name = "ValidDate",
        semanticId = "iri:https://admin-shell.io/ZVEI/TechnicalData/ValidDate/1/1",
