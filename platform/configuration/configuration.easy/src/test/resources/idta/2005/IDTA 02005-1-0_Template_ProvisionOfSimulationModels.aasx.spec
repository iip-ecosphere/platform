project IDTA_02005_SimulationModels {
  ...
  AasSubmodelType SimulationModels = {
    ...
    description = "Das Submodel kann ein oder meherer Simulationsmodelle bereitstellen, einen Service zur Generierung eines spezifischen Modells oder einen Zugang zu einer offenen oder spezifischen Anfrage.",
    fields = {
      AasField {
        ...
        minimumInstances = 0,
        description = "Merkmalssammlung zur Bereitstellung oder Anfrage von Simulationsmodellen. Die Modelle können von der Zielstellung und inhaltlich beschrieben werden."
      }
    }
  };
  ...
  AasSubmodelElementCollectionType SimulationModel = {
    ...
    fields = {
      ...
      AasField {
        ...
        minimumInstances = 0,
        description = "Documentation of example simulations of the model can be supplied. This includes a solver setup and sample circuit and sample results. e.g. zip file, PDF, html, ..."
      },
      AasField {
        name = "ModelFile",
  ...
  AasSubmodelElementCollectionType Environment = {
    ...
    fields = {
      ...
      AasField {
        ...
        minimumInstances = 1,
        description = "Eigenschaften des Modells bezüglich konkreter Simulationswerkzeuge."
      }
    }
  };
  ...
  AasSubmodelElementCollectionType SimulationTool = {
    ...
    fields = {
      AasField {
        name = "SimToolName",
        semanticId = "iri:https://admin-shell.io/idta/SimulationModel/SimToolName/1/0",
        type = refBy(StringType),
        minimumInstances = 1,
        maximumInstances = 1
      },
  ...
  AasSubmodelElementCollectionType SimModManufacturerInformation = {
    ...
    fields = {
      AasField {
        name = "Company",
        semanticId = "iri:0173-1#02-AAW001#001",
        type = refBy(StringType),
        minimumInstances = 1,
        maximumInstances = 1,
      ...
      AasField {
        name = "Language",
        semanticId = "iri:0173-1#02-AAO895#003",
        type = refBy(StringListType),
        minimumInstances = 1,
      ...
      AasField {
        name = "Email",
        semanticId = "iri:0173-1#02-AAQ836#005",
        type = refBy(Email),
        minimumInstances = 0,
        maximumInstances = 1,
  ...
  AasSubmodelElementCollectionType PortsConnector = {
    ...
    fields = {
      AasField {
        ...
        semanticId = "iri:https://admin-shell.io/idta/SimulationModels/PortsConnectorName/1/0",
        type = refBy(StringType),
        minimumInstances = 1,
        maximumInstances = 1,
      ...
      AasField {
        ...
        semanticId = "iri:https://admin-shell.io/idta/SimulationModel/portConDescription/1/0",
        type = refBy(AasMultiLangStringType),
        minimumInstances = 0,
        maximumInstances = 1,
  ...
  AasSubmodelElementCollectionType Variable = {
    ...
    fields = {
      ...
      AasField {
        ...
        minimumInstances = 0,
        maximumInstances = 1,
        description = "Prefix for acausal variable. Potential variables are set equal when connecting (no prefix). Stream variables are connected according to Kirchhoff's law, i.e. the sum of the variables equals zero. The bi-directional flow of matter is described with 'stream' (e.g. for enthalpy)."
      }
    }
  };
