...
[Docker](https://www.docker.com/) extension/implementation of the SPI interfaces of the oktoflow container management agent (ECSruntime) running on compute resources.
