...
|                              |           Windows       |        Linux       |
|------------------------------|-------------------------|--------------------|
| native | :heavy_check_mark:  | :heavy_check_mark:      | :heavy_check_mark: |
| Docker with Linux container  | WSL :heavy_check_mark:  | :heavy_check_mark: | 
| Docker with Windows container|        :question:       |         :x:        | 
...
| kiservices.functions, flower service/server  | numpy*        | 1.20.1    |  2.0.2      | 2.2.4       |
| kiservices.functions                         | pillow        | 9.1.0     |  9.1.0      | 11.3.0      |
| flower service/server                        | flwr          | 1.2.0     |  1.23.0     | 1.27.0      |
| flower service/server                        | tensorflow*   | 2.9.0     |  2.20.0     | 2.21.0      |
| flower service/server                        | torch*        | 2.0.1     |  2.8.0      | 2.10.0      |

Alternative dependencies within one component are marked by *.
