...
Speeding up builds by just updating the artifacts such as Python code can be achieved by activating the "Art" profile. For all-in-one examples, this would be then `mvn -P App,Art install`, which implies an artifact-based update of the application. For service implementation projects, the artifact profile is generated into the POM of the application template and may have to be taken over, the invoker for the application POM must be activated manually, because service implementation projects may not have access to the application (shall be availalbe on the UI in future). In full application POMs, the Art profile is included through artifact generation.
...
|           | install, package          | `-DskipTests`                               | Usual, non-invoker builds: disable Java tests                                                                                                 | mvn surefire-plugin                                                |
|           | install, package          | `-Dmaven.test.skip`                         | Disable Java testing                                                                                                                          | mvn surefire-plugin                                                |
|           | install, package          | `-Dmaven.main.skip`                         | Disable Java compilation                                                                                                                      | mvn compiler-plugin                                                |
|           | install, package          | `-Dmaven.javadoc.skip`                      | enables/disables Java documentation building                                                                                                  | mvn javadoc-plugin                                                 | 
|           | install, package          | `-Deasy.docker.skip=<bool>`                 | enables/disables Docker container building                                                                                                    | EASy-Producer                                                      |
|           | install, package          | `-Deasy.docker.failOnError=<bool>`          | enables/disables ingoring Docker build failures                                                                                               | EASy-Producer                                                      |
|           | install, package          | `-Dokto.easy.allTypes=<bool>`               | enables/disables focusing on declared types only, default is `true`                                                                           | oktoflow metamodel                                                 |
|           | install, package          | `-Dokto.easy.allServices=<bool>`            | enables/disables focusing on declared services only, default is `true`                                                                        | oktoflow metamodel                                                 |
