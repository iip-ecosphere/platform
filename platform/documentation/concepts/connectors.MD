...
The OPC UA  connector is a model connector with no further fields. Regarding authentication, this connector supports `USERNAME`, `ISSUED`, `X509` and `ANONYMOUS` authentication tokens as well as TLS encryption.
