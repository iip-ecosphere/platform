...
The `AllServices` is a service IVML configuration file which is part of oktoflow platform examples: [Asynchronous Python](../../examples/examples.python). The `AllServices` includes three services:
