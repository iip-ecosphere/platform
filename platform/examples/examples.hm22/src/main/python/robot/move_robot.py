...
restart_file = os.getcwd()+"/restart_tablet_program.sh"
st = os.stat(restart_file)
os.chmod(restart_file, st.st_mode | stat.S_IXOTH)
subprocess.call(restart_file,shell=True)
