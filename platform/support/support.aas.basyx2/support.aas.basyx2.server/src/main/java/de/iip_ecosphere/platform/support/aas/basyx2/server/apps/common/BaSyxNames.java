...
public class BaSyxNames {
    ...
    public static final String PACKAGE_BASYX = "org.eclipse.digitaltwin.basyx";
    public static final String PACKAGE_PLUGIN_BASYX_SERVER 
    ...
    public static final String PACKAGE_PLUGIN_BASYX_SERVER_COMMON 
        = PACKAGE_PLUGIN_BASYX_SERVER + ".apps.common";
    ...
    public static final String AAS_REGISTRY_SERVICE_CFG 
    ...
    public static final String SM_REGISTRY_SERVICE_STORAGE 
