...
package de.iip_ecosphere.platform.support.aas.basyx2.apps.aasEnvironment;
 ...
 */
public class AasEnvironmentTypeFilter extends InclusionBasedTypeFilter {
    
    /**
     * Sets up the filtering for the AAS environment.
     */
    public AasEnvironmentTypeFilter() {
        addInclusion(AAS_ENVIRONMENT);
    }
