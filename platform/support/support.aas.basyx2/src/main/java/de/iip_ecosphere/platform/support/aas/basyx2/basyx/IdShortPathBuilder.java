package de.iip_ecosphere.platform.support.aas.basyx2.basyx;
...
public class IdShortPathBuilder {
     ...
     * 
     * @param idShortPathElements the ids of the submodel elements to use
     */
    ...
    public String build() {
        ...
        while (j < idShortPathElements.size()) {
            ...
            if (parentSME instanceof SubmodelElementList) {
                appendSMLIdShortPath(isFirstElement, previousOccurrenceSubmodelElementList, idShortPathBuilder, 
                    parentSME, childSME);
     ...
     * 
     * @param isFirstElement is this the first element
     * @param idShortPathBuilder the string builder for the path
     * @param parentSME the parent SME
     */
     ...
     * 
     * @param isFirstElement is this the first element
     * @param previousOccurrenceSubmodelElementList whether the previous occurence is a SML
     * @param idShortPathBuilder the string builder for the path
     * @param parentSME the parent SME
     * @param childSME the child SME to process 
     */
     ...
     * 
     * @param idShortPathElements the id short of the given elements
     */
    private void validateIdShortPathElements(List<SubmodelElement> idShortPathElements) {
        if (idShortPathElements == null || idShortPathElements.isEmpty()) {
            throw new InvalidIdShortPathElementsException("List of SubmodelElements for creating IdShortPath "
