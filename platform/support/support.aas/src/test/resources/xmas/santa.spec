AAS santa
 ASSET santa INSTANCE
 SUBMODEL LivingData
  PROPERTY age = 1753
  PROPERTY clothsColor = red
  PROPERTY displayName = Santa Claus
  PROPERTY name = Nikolaus von Myra
 SUBMODEL TechnicalData (semanticId: iri:https://admin-shell.io/ZVEI/TechnicalData/Submodel/1/2)
  ...
  SMC GeneralInformation (semanticId: iri:https://admin-shell.io/ZVEI/TechnicalData/GeneralInformation/1/1)
   PROPERTY ManufacturerArticleNumber = SC-001 (semanticId: irdi:0173-1#02-AAO676#003)
   PROPERTY ManufacturerName = The Lord (semanticId: irdi:0173-1#02-AAO677#002)
   PROPERTY ManufacturerOrderCode = SC-001 (semanticId: irdi:0173-1#02-AAO227#002)
   MLP ManufacturerProductDesignation (semanticId: irdi:0173-1#02-AAW338#001)
   FILE ProductImage01 (semanticId: iri:https://admin-shell.io/ZVEI/TechnicalData/ProductImage/1/1) length 37
  SMC ProductClassifications (semanticId: iri:https://admin-shell.io/ZVEI/TechnicalData/ProductClassifications/1/1)
   SMC ProductClassificationItem01 (semanticId: iri:https://admin-shell.io/ZVEI/TechnicalData/ProductClassificationItem/1/1)
    ...
    PROPERTY ProductClassId = 0173-1#01-ADT348#005 (semanticId: iri:https://admin-shell.io/ZVEI/TechnicalData/ProductClassId/1/1)
