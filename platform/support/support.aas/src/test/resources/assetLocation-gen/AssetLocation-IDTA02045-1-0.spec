AAS AssetLocationExample
 ...
 SUBMODEL AssetLocation (semanticId: iri:https://admin-shell.io/idta/smt/assetlocation/1/0)
  SML Addresses (semanticId: iri:https://admin-shell.io/idta/sml/addresses/1/0)
  ...
  SMC AssetTraces (semanticId: iri:https://admin-shell.io/idta/smc/assettraces/1/0)
   ...
   SML AreaRecords (semanticId: iri:https://admin-shell.io/idta/sml/arearecords/1/0)
   ...
   SML LocationRecords (semanticId: iri:https://admin-shell.io/idta/sml/locationrecords/1/0)
  ...
  SML CoordinateSystems (semanticId: iri:https://admin-shell.io/idta/sml/coordinatesystems/1/0)
  ...
  SML VisitedAreas (semanticId: iri:https://admin-shell.io/idta/sml/visitedareas/1/0)
