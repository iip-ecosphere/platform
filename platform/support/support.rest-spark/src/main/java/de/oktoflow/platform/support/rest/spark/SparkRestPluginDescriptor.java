...
public class SparkRestPluginDescriptor extends SingletonPluginDescriptor<Rest> implements RestProviderDescriptor {
    
    /**
     * Creates the descriptor.
     */
    public SparkRestPluginDescriptor() {
        super("rest-spark", null, Rest.class, p -> new SparkRest());
    }
    
    @Override
    public Rest create() {
        return new SparkRest();
    }
