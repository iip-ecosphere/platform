# oktoflow platform: SemanticId resolver for ECLASS
...
The resolver relies on the IdentityStore of the oktoflow platform and obtains the user authentication token and 
...
The Eclass semantic resolver is an optional extension of the oktoflow platform.
