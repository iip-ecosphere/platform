...
import de.iip_ecosphere.platform.support.http.HttpProviderDescriptor;
...
public class ApacheHttpRestPluginDescriptor extends SingletonPluginDescriptor<Http> implements HttpProviderDescriptor {
    
    /**
     * Creates the descriptor.
     */
    public ApacheHttpRestPluginDescriptor() {
        super("http-apache", null, Http.class, p -> new ApacheHttp());
    }
