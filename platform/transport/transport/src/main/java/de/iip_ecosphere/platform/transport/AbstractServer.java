...
/**
 * A basic abstract server base class for experiments.
 * 
...
public abstract class AbstractServer implements Server {
    ...
    public static void extractConfiguration(String location, String dfltConfigDir) throws IOException {
        extractConfiguration(AbstractServer.class.getClassLoader(), location, dfltConfigDir);
    }
    ...
    public static boolean runsFromJar() {
        String intlName = AbstractServer.class.getName().replace('.', '/');
        String classJar = AbstractServer.class.getResource("/" + intlName + ".class").toString();
